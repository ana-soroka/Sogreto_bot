...
async def handle_complete_stage(query, user, db):
    ...
    if stage:
        ...
        # Практики закончились — ставим stage 7 чтобы scheduler не слал уведомления
        ...
        logger.info(f"Пользователь {user.telegram_id} завершил ВСЕ практики! current_stage=7")
